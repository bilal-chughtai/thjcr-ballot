...
parser.add_argument("--google-sheet-name", requird=True, help="Name of the single sheet on the Google doc to read updates from", type=str)
...
while True:
    ...
    new_rooms = RoomDataParser(sheet_reader.get_sheet(), sheet_columns_format, room_name_to_svg_id.names_to_ids(), logger)
